...
open class SharedPreferences(context : Context, sharedName : String) {
    ...
    private val preferences = context.getSharedPreferences(sharedName + prefix, Context.MODE_PRIVATE)
    ...
    fun <T : Any> getObject(key : String, anonymousClass : Class<T>) : T = gson.fromJson(preferences.getString(key, ""), anonymousClass)
