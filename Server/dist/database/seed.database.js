...
var SeedDatabase = /** @class */ (function () {
    function SeedDatabase(connection) {
        this.logger = new common_1.Logger("SeedDatabase");
        this.connection = connection;
    }
    SeedDatabase.prototype.seed = function () {
        return __awaiter(this, void 0, void 0, function () {
            var roomTypeRepository, roomTypes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        roomTypeRepository = this.connection.getRepository(room_type_entity_1.RoomType);
                        return [4 /*yield*/, roomTypeRepository.find()];
                    case 1:
                        roomTypes = _a.sent();
                        if (roomTypes.length <= 0) {
                            this.logger.debug("Insert first data room type");
                        }
                        this.logger.log(roomTypes);
                        return [2 /*return*/];
                }
            });
        });
